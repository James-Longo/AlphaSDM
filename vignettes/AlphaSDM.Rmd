...
|:--------|-------:|-------:|-----:|-----:|
|svm      |   0.807|   0.786| 0.486| 0.330|
|rf       |   0.775|   0.726| 0.423| 0.906|
|gbt      |   0.727|   0.661| 0.331| 0.737|
|ensemble |   0.770|   0.723| 0.392| 0.725|
...
|                            | auc_roc| auc_prg|   tss|   cbi|
|:---------------------------|-------:|-------:|-----:|-----:|
|default (linear classifier) |   0.807|   0.786| 0.486| 0.330|
|regression, RBF kernel      |   0.792|   0.722| 0.462| 0.959|



The Boyce index rises from 0.33 to
