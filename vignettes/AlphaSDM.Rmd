...
|:--------|-------:|-------:|-----:|-----:|
|svm      |   0.807|   0.786| 0.486| 0.294|
|rf       |   0.766|   0.705| 0.400| 0.911|
|gbt      |   0.722|   0.639| 0.339| 0.745|
|ensemble |   0.762|   0.703| 0.383| 0.730|
...
|                            | auc_roc| auc_prg|   tss|   cbi|
|:---------------------------|-------:|-------:|-----:|-----:|
|default (linear classifier) |   0.807|   0.786| 0.486| 0.294|
|regression, RBF kernel      |   0.792|   0.722| 0.463| 0.959|



The Boyce index rises from 0.29 to
