...
# Set paths
ebd_path <- "/path/to/Projects/autoSDM/benchmarks/ebd_bicthr_unv_smp_relDec-2025/ebd_bicthr_unv_smp_relDec-2025.txt"
output_path <- "/path/to/Projects/autoSDM/benchmarks/ebd_bicthr_winter_processed.csv"
